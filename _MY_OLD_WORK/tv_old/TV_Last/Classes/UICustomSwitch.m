...
-(void)awakeFromNib
{
	...
	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(4,4,300,23)];
	...
	NSString *leftLabelText = NSLocalizedString(@"ON","Custom UISwitch ON label.");
	...
	self.leftLabel.frame = CGRectMake(3, 4, 100, 24);
	...
	NSString *rightLabelText = NSLocalizedString(@"OFF","Custom UISwitch OFF label.");
	...
	self.rightLabel.frame = CGRectMake(105, 0, 48, 23);
