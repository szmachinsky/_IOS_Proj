...
//		self.tabBarItem.image = [UIImage imageNamed:@"t_search.png"];
        
        CustomTabBarItem *tabItem = [[CustomTabBarItem alloc] initWithTitle:@"Обновить" image:[UIImage imageNamed:@"t_search.png"] tag:0];
        tabItem.customHighlightedImage=[UIImage imageNamed:@"t_search.png"];
