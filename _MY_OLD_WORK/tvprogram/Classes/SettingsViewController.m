...
//		self.tabBarItem.image = [UIImage imageNamed:@"t_settings.png"];
        
        CustomTabBarItem *tabItem = [[CustomTabBarItem alloc] initWithTitle:@"Настройки" image:[UIImage imageNamed:@"t_settings.png"] tag:0];
        tabItem.customHighlightedImage=[UIImage imageNamed:@"t_settings.png"];
...
//    backButton.image = [UIImage imageNamed:@"back_color.png"];
